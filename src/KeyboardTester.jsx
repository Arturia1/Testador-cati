...
const LAYOUTS = {
  positivo_sk6620: {
    ...
    keys: [
      ...
      { code: 'NumpadDecimal', label: ',', grid: '6 / 24' } // Ajustado para ficar ao lado do 0
    ]
  }
};
...
export default function KeyboardTester() {
  ...
  // Regra flexível: Pode rejeitar se tiver texto E (teclas rejeitadas OU serial preenchido)
  ...
  useEffect(() => {
    // IMPORTANTE: Se o form estiver aberto, não captura eventos de teclado para o teste
    // Isso permite digitar nos inputs sem pintar o teclado
    ...
    const handleKeyDown = (e) => {
      ...
      // Lógica de reconhecimento de caractere no Numpad
  ...
  const exportAsImage = async () => {
    if (reportRef.current) {
      ...
      link.download = `LAUDO_${dispositivoSerial || 'TECLADO'}_${new Date().getTime()}.png`;
      link.click();
    }
  };
          ...
          <div className="report-body">
            <section className="report-info-grid">
              ...
              <div className={`status-stamp-large ${resultStatus}`}>
                {resultStatus === 'approved' ? 'CERTIFICADO: OK' : 'REPROVADO'}
              </div>
            </section>
            ...
            <div className="report-details-box">
              ...
              <div className="observation-text">
                {resultStatus === 'approved' ? (
                  ...
                  <>
                    <p><strong>Diagnóstico de Falha:</strong> {reportText}</p>
                    <p><strong>Mapeamento de Erro:</strong> <span className="highlight-danger">{[...rejectedKeys].join(', ')}</span></p>
                  </>
                )}
              </div>
        ...
        {!showReportForm ? (
          ...
          <div className="report-form-active">
            ...
            <div className="form-btns">
              ...
              {/* Só mostra se o modo for 'approve' */}
              {showReportForm === 'approve' && (
                <button 
              ...
              {/* Só mostra se o modo for 'reject' */}
